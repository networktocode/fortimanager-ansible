...
def main():
    argument_spec = dict(
        ...
        address_group_name=dict(required=True, type="str"),
    ...
    args = {
        ...
        "name": module.params["address_group_name"]
    }
    ...
    session = FMAddressGroup(host, username, password, use_ssl, validate_certs, adom)
    if not session_id:
