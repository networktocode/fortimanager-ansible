...
def main():
    argument_spec = dict(
        ...
        service_group_name=dict(required=True, type="str")
    )
    ...
    args = {
        ...
        "name": module.params["service_group_name"]
    }
    ...
    session = FMServiceGroup(host, username, password, use_ssl, validate_certs, adom)
    if not session_id:
